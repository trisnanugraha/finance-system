  ...
  <div class="modal-content">
    <div class="modal-header bg-primary ">
      <h3 class="modal-title">
        <center>Add New Asuransi</center>
      </h3>
    </div>

    <form id="form-tambah-asuransi" method="POST">
      <div class="modal-body">
        ...
        <div class="form-group">
          <label class="control-label col-xs-4">Total Asuransi</label>
          <div class="col-xs-8">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" id="add" class="btn btn-primary">Add Data</button>
        </div>
    </form>
  </div>
</div>
...
<script>
  $('#period').on("change", function() {
    ...
    $.ajax({
      method: 'GET',
      url: '<?php echo base_url('Asuransi/countAvailablePeriod'); ?>',
      data: {
        period: period
      },
      dataType: 'json',
