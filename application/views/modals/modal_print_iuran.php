<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <h3 style="display:block; text-align:center;">Print Multiple Iuran</h3>

  <form id="form-tambah-tarif" target="_blank" action="<?= base_url('Iuran/printMultiple') ?>" method="POST">
    <br>
