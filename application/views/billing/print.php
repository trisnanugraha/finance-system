                    ...
                    <table>
                        ...
                        <tr>
                            <td class="border padding-left padding-right" colspan="2" style="padding-top: 5px; padding-bottom:5px;">
                                ...
                                <ol type="1">
                                    <li>Through Automatic Teller Machine (ATM) of Bank Central Asia (BCA) by Choosing transfer menu to your <span style="font-size: 15px;">BCA Virtual Account for <span id="virtual-account-number"><?= $billing->kode_virtual; ?></span></span></li>
