                ...
                <td colspan="2">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="border-left border-right padding-top text-align-right"><span id="total-current"><?= money($sc->total_asuransi + $sc->stamp); ?></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr class="text-align-right">
                            ...
                            <td class="border-left border-bottom border-right text-align-right" style="padding-top: 5px; padding-bottom:5px;"><span id="total-amount-due"><?= money(round($sc->total_asuransi + $sc->stamp + $sc->previous * 3 / 100 + $sc->previous)); ?></span></td>
                        </tr>
                        <tr>
                            <td class="padding-top padding-left text-valign-top padding-bottom">In Word &nbsp;&nbsp;&nbsp;&nbsp;: <span id="in-word"><?= ucwords(number_to_words_rupiah(($sc->total_asuransi + $sc->stamp + $sc->previous * 3 / 100 + $sc->previous))) ?></span></td>
